...
class App:
    def __init__(self):
        ...
        self.Button1 = Button(font = 'Arial 16 bold', background = 'blue', foreground = 'white', text = 'Consultar CNPJ', command=self.consultarCNPJ)
    ...
    def consultarCNPJ(self):
        cnpj_digitado = self.Entry1.get()
        consulta = requests.get(f"https://brasilapi.com.br/api/cnpj/v1/{cnpj_digitado}")
